...
<img src="https://readme-typing-svg.demolab.com?font=Fira+Code&size=18&pause=1000&color=2E5F8A&center=true&vCenter=true&width=500&lines=Buscando+est%C3%A1gio+em+TI;Sempre+aprendendo+algo+novo+%F0%9F%9A%80" alt="Typing SVG" />
...
| Projeto | Descrição |
|---|---|
| 🔗 [**projeto_ollama**](https://github.com/guismdonofrio/projeto_ollama) | Sistema de gestão aeroportuária com IA local (LangChain4J + Ollama), integrado a banco de dados MySQL via Spring Boot |
| 🔗 [**api_datasquad-gestaoacademica**](https://github.com/guismdonofrio/api_datasquad-gestaoacademica) | API REST desenvolvida em squad para gestão acadêmica |
...
<p align="left">
  <a href="mailto:guilhermina1610@gmail.com">
...
<sub>💡 Perfil em constante evolução — sempre aprendendo algo novo!</sub>
